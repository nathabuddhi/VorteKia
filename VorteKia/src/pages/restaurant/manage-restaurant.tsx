...
import { ViewAllOrders } from "@/components/restaurant/view-order-history";
import { Button } from "@/components/ui/button";
import AllocateRestaurantStaff from "@/components/restaurant/allocate-restaurant-staff";
import EditRestaurant from "@/components/restaurant/edit-restaurant";
import {
    AlertDialog,
    AlertDialogCancel,
    AlertDialogContent,
...
export default function ManageRestaurantPage() {
    ...
    async function deleteRestaurant() {
        ...
        const response = deleteRestaurantPromise(restaurant.id);
        toast.promise(response, {
            loading: "Deleting restaurant...",
            success: "Restaurant deleted successfully!",
            error: "Failed to delete restaurant: " + (await response).message,
        });
    }
            ...
            <NeonGradientCard className="w-[calc(100vh-10rem)] h-[calc(100vh-13rem)] ">
                <Tabs defaultValue="information">
                    ...
                    <TabsContent value="information">
                        ...
                        <MagicCard
                            ...
                            <div className="mt-4 flex flex-col gap-y-2">
                                ...
                                <Label>
                                    Restaurant Income: ${restaurant?.income}
                                </Label>
                    ...
                    <TabsContent value="history">
                        {restaurant && (
                            <ViewAllOrders restaurant={restaurant} />
                        )}
                    </TabsContent>
                </Tabs>
            </NeonGradientCard>
